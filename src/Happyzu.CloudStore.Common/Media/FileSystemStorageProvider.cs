...
namespace Happyzu.CloudStore.Common.Media
{
    public class FileSystemStorageProvider : IStorageProvider
    {
        ...
        public FileSystemStorageProvider(string dirName)
        {
            var mediaPath = HostingEnvironment.IsHosted
                                ? HostingEnvironment.MapPath("~/Media/") ?? ""
                                : Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Media");

            _storagePath = Path.Combine(mediaPath, dirName);
            _virtualPath = "~/Media/" + dirName + "/";
            ...
            _publicPath = appPath + "Media/" + dirName + "/";
        ...
        public IStorageFile GetFile(string path)
        {
            ...
            if (!fileInfo.Exists)
            {
                throw new ArgumentException(string.Format("File {0} does not exist", path).ToString());
            }
        ...
        public IEnumerable<IStorageFile> ListFiles(string path)
        {
            ...
            {
                throw new ArgumentException(string.Format("Directory {0} does not exist", path).ToString());
            }
        ...
        public IEnumerable<IStorageFolder> ListFolders(string path)
        {
            ...
            if (!directoryInfo.Exists)
            {
                ...
                {
                    throw new ArgumentException(string.Format("The folder could not be created at path: {0}. {1}", path, ex).ToString());
                }
            }
        ...
        public void CreateFolder(string path)
        {
            ...
            if (directoryInfo.Exists)
            {
                throw new ArgumentException(string.Format("Directory {0} already exists", path).ToString());
            }
        ...
        public void RenameFolder(string oldPath, string newPath)
        {
            ...
            {
                throw new ArgumentException(string.Format("Directory {0} does not exist", oldPath).ToString());
            }

            DirectoryInfo targetDirectory = new DirectoryInfo(MapStorage(newPath));
            if (targetDirectory.Exists)
            {
                throw new ArgumentException(string.Format("Directory {0} already exists", newPath).ToString());
            }
        ...
        public void RenameFile(string oldPath, string newPath)
        {
            ...
            {
                throw new ArgumentException(string.Format("File {0} does not exist", oldPath).ToString());
            }

            FileInfo targetFileInfo = new FileInfo(MapStorage(newPath));
            if (targetFileInfo.Exists)
            {
                throw new ArgumentException(string.Format("File {0} already exists", newPath).ToString());
            }
        ...
        public IStorageFile CreateFile(string path)
        {
            ...
            if (fileInfo.Exists)
            {
                throw new ArgumentException(string.Format("File {0} already exists", fileInfo.Name).ToString());
            }
        ...
        private class FileSystemStorageFolder : IStorageFolder
        {
            ...
            public IStorageFolder GetParent()
            {
                ...
                throw new ArgumentException(string.Format("Directory {0} does not have a parent directory", _directoryInfo.Name).ToString());
            }
